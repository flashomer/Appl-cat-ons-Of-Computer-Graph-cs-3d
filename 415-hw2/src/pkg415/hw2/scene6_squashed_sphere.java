 ...
 * @author flashomer
 */
public class scene6_squashed_sphere extends Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        jFileName             = "scene6_squashed_sphere";
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        transformScale = groups.getJSONObject(0).getJSONObject("transform").getJSONArray("transformations").getJSONObject(0).getJSONArray("scale");
