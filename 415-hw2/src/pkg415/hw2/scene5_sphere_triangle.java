 ...
 * @author flashomer
 */
public class scene5_sphere_triangle extends Application {
    ...
    public static void main(String[] args) throws Exception {
        ...
        jFileName             = "scene5_sphere_triangle";
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        if(groups.getJSONObject(i).names().getString(0).equals("plane")) {
            ...
            group.getChildren().add( addPlane(groups.getJSONObject(i).getJSONObject("plane").getJSONArray("normal"),
                    ...
                    groups.getJSONObject(i).getJSONObject("plane").getJSONArray("color")) ); 
            
        } else if(groups.getJSONObject(i).names().getString(0).equals("triangle")) {
           
            group.getChildren().add( addTriangle(
                    groups.getJSONObject(i).getJSONObject("triangle").getJSONArray("v1"),
                    groups.getJSONObject(i).getJSONObject("triangle").getJSONArray("v2"),
                    groups.getJSONObject(i).getJSONObject("triangle").getJSONArray("v3"),
                    groups.getJSONObject(i).getJSONObject("triangle").getJSONArray("color") )); 
